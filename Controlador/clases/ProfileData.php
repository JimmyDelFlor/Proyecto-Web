...
class ProfileData {
  ...
  public function __construct($con, $profileUsername) {
    $this->con = $con;
    $this->profileUserObj = new usuario($con, $profileUsername);
  }
  ...
  public function getAllUserDetails() {
    return array(
      "Nombre" => $this->getProfileUserFullName(),
      "Username" => $this->getProfileUsername(),
      "Suscriptores" => $this->getSubscriberCount(),
      "Vistas Totales" => $this->getTotalViews(),
      "Fecha de registro" => $this->getSignUpDate()
    );
  }
  ...
  private function getSignUpDate() {
    ...
    $dateString = date('j \\d\\e F \\d\\e Y', $timestamp);
