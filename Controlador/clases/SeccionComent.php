...
class SeccionComment {
  ...
  private function createCommentSection() {
    ...
    $commentButton = botones::createButton("COMENTAR", null, $commentAction, "postComment");
    ...
    return "<div class='commentSection'>
              ...
              <div class='header'>
                <span class='commentCount'>$numComments Comentarios</span>
                <div class='commentForm'>
                  $profileButton
                  
                  <textarea class='commentBodyClass' placeholder='Agrega un comentario'></textarea>
                  $commentButton
                </div>
              </div>
