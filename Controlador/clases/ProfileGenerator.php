...
class ProfileGenerator {
  ...
  public function createContentSection() {
    ...
    if(sizeof($videos) > 0) {
      $videoGrid = new MostrarVideo($this->con, $this->userLoggedInObj);
      $videoGridHtml = $videoGrid->create($videos, null, false);
    } else {
      $videoGridHtml = "<span>Este usuario aún no sube videos</span>";
    }
  ...
  private function createHeaderButton() {
    if($this->userLoggedInObj->getUsername() == $this->profileData->getProfileUsername()) {
      ...
      return botones::createSubscriberButton($this->con, $this->profileData->getProfileUserObj(), $this->userLoggedInObj);
    }
  }
