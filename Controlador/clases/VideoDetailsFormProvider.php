  ...
  class VideoDetailsFormProvider {
    ...
    private function createFileInput() {
      return "<div class='form-group'>
                <label for='exampleFormControlFile1'>Tu archivo</label>
    ...
    private function createTitleInput($value) {
      if($value ==null) $value = "";
      return "<div class='form-group'>
                <input class='form-control' type='text' placeholder='Titulo' name='titleInput' value='$value'>
              </div>";
    }
    ...
    private function createDescriptionInput($value) {
      if($value ==null) $value = "";
      return "<div class='form-group'>
                <textarea class='form-control' placeholder='Descripción' name='descriptionInput' rows='3'>$value</textarea>
              </div>";
    }
    ...
    private function createPrivacyInput($value) {
      ...
      return "<div class='form-group'>
                <select class='form-control' name='privacyInput'>
                  <option value='0' $privateSelected>Privado</option>
                  <option value='1' $publicSelected>Público</option>
                </select>
              </div>";
    }
    ...
    private function createUploadButton() {
      return "<button type='submit' class='btn btn-primary' name='uploadButton'>Subir video</button>";
    }

    private function createSaveButton() {
      return "<button type='submit' class='btn btn-primary' name='saveButton'>Guardar</button>";
    }
  }
?>